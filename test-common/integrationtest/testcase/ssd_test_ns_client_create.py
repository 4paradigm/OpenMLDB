...
class TestCreateTableByNsClient(TestCaseBase):
    ...
    @ddt.data(
        ...
        ('t{}'.format(time.time()), None, -1, 8,
         'E0927 16:05:14.655971  7800 src/brpc/global.cpp:260] google/protobuf/text_format.cc:274 Error parsing text-format rtidb.client.TableInfo: 32:6: Expected integer.\ntable meta file format error'),
