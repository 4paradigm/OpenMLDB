...
class TestNameserverHa(TestCaseBase):
    ...
    def get_steps_dict():
        return {
            ...
            10: 'None',
            12: 'self.assertEqual(self.get_manifest_by_realpath(self.leaderpath+"/ssd_db", self.tid, self.pid)["offset"], "3510")',   #self.get_manifest_by_realpath(self.leaderpath + "/" + db_path, tid, pid)
