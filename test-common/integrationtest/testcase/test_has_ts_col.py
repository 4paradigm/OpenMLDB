...
class TestHasTsCol(TestCaseBase):
    ...
    def test_count_schema_has_ts_col(self):
        ...
        rs1 = self.ns_put_multi_has_ts_col(self.ns_leader,name, ['card0', 'mcc0', '1', '15', '18'])
        self.assertIn('Put ok', rs1)
        rs2 = self.ns_put_multi_has_ts_col(self.ns_leader, name, ['card0', 'mcc1', '2', '16', '19'])
        self.assertIn('Put ok', rs2)
        rs3 = self.ns_put_multi_has_ts_col(self.ns_leader, name, ['card1', 'mcc2', '3', '20', '20'])
        self.assertIn('Put ok', rs3)

        rs4 = self.ns_count_has_ts_col(self.ns_leader, name, 'card0', 'card', 'ts1')
        self.assertIn('count: 2', rs4)
        rs5 = self.ns_count_has_ts_col(self.ns_leader, name, 'card0', 'card', 'ts2')
        self.assertIn('count: 2', rs5)
        rs6 = self.ns_count_has_ts_col(self.ns_leader, name, 'card1', 'card', 'ts1')
        self.assertIn('count: 1', rs6)
        rs7 = self.ns_count_has_ts_col(self.ns_leader, name, 'card1', 'card', 'ts2')
        self.assertIn('count: 1', rs7)
        rs8 = self.ns_count_has_ts_col(self.ns_leader, name, 'mcc1', 'mcc', 'ts1')
        self.assertIn('count: 0', rs8)
        rs9 = self.ns_count_has_ts_col(self.ns_leader, name, 'mcc1', 'card', 'ts1')
        self.assertIn('count: 0', rs9)
        rs10 = self.ns_count_has_ts_col(self.ns_leader, name, 'mcc1', 'k1', 'ts1')
        self.assertIn('idx name not found', rs10)
        rs11 = self.ns_count_has_ts_col(self.ns_leader, name, 'mcc1', 'mcc', 'ts3')
    ...
    def test_scan_schema_has_ts_col(self):
        ...
        rs4 = self.ns_scan_multi_has_ts_col(self.ns_leader, name, 'card0', 'card',  '25', '0', 'ts1')
        ...
        rs5 = self.ns_scan_multi_has_ts_col(self.ns_leader, name, 'card0', 'card',  '25', '0', 'ts1', '1')
    ...
    def test_get_schema_has_ts_col(self):
        ...
        rs4 = self.ns_get_multi_has_ts_col(self.ns_leader, name, 'card0', 'card', '16', 'ts1')
        ...
        rs5 = self.ns_get_multi_has_ts_col(self.ns_leader, name, 'card0', 'card', '18', 'ts2')
