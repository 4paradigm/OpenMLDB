...
class TestSetTTL(TestCaseBase):
    ...
    #
    #     rs_latest5 = self.ns_put_kv_cmd(self.ns_leader, 'put', 'latest1', 'testkey1', str(rs_time), 'testvalue1')
    #     self.assertIn('Put ok', rs_latest5)
    #
    #     rs_latest6 = self.ns_get_kv_cmd(self.ns_leader, 'get', 'latest1', 'testkey0', str(rs_time))
    #     infoLogger.error(rs_latest6)
    #     self.assertFalse('testvalue0' in rs_latest6)
    #     rs_absolute5 = self.ns_get_kv_cmd(self.ns_leader, 'get', 't1', 'testkey0', str(rs_time))
    #     infoLogger.error(rs_absolute5)
