...
class TbCluster(object):
    ...
    def start(self, endpoints, is_remote = False):
        ...
        for ep in endpoints:
            ...
            exe_shell("echo '--recycle_bin_ssd_root_path={}/ssd_recycle/' >> {}".format(tb_path, rtidb_flags))
            exe_shell("echo '--recycle_bin_hdd_root_path={}/hdd_recycle/' >> {}".format(tb_path, rtidb_flags))
