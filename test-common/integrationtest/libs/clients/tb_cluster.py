...
class TbCluster(object):
    ...
    def start(self, endpoints):
        ...
        for ep in endpoints:
            ...
            ssd_path = test_path + '/tablet{}'.format(i)
            hdd_path = test_path + '/tablet{}'.format(i)
            exe_shell('export ')
            ...
            exe_shell("sed -i '1a --ssd_root_path={}/db' {}".format(ssd_path, rtidb_flags))
            exe_shell("sed -i '1a --hdd_root_path={}/db' {}".format(hdd_path, rtidb_flags))
            ...
            exe_shell("sed -i '1a --recycle_ssd_bin_root_path={}/recycle' {}".format(ssd_path, rtidb_flags))
            exe_shell("sed -i '1a --recycle_hdd_bin_root_path={}/recycle' {}".format(hdd_path, rtidb_flags))
