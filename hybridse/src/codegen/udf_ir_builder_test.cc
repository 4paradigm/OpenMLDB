...
void CheckUdfFail(const std::string &name, T expect, Args... args) {
    auto function = udf::UdfFunctionBuilder(name).args<Args...>().template returns<T>().build();
...
TEST_F(UdfIRBuilderTest, minute_int64_udf_test) { CheckUdf<int32_t, int64_t>("minute", 43, 1590115420000L); }
...
TEST_F(UdfIRBuilderTest, dayofmonth_int64_udf_test) { CheckUdf<int32_t, int64_t>("dayofmonth", 22, 1590115420000L); }
TEST_F(UdfIRBuilderTest, month_int64_udf_test) { CheckUdf<int32_t, int64_t>("month", 5, 1590115420000L); }
TEST_F(UdfIRBuilderTest, year_int64_udf_test) { CheckUdf<int32_t, int64_t>("year", 2020, 1590115420000L); }
...
TEST_F(UdfIRBuilderTest, weekofyear_int64_udf_test) {
    ...
    //     Sunday
    CheckUdf<int32_t, int64_t>("dayofmonth", 24, 1590115420000L + 2 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 21, 1590115420000L + 2 * 86400000L);
    //     Monday
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 3 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 4 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 5 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 6 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 7 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 8 * 86400000L);
    CheckUdf<int32_t, int64_t>("weekofyear", 22, 1590115420000L + 9 * 86400000L);

    // Monday
    CheckUdf<int32_t, int64_t>("weekofyear", 23, 1590115420000L + 10 * 86400000L);
}
TEST_F(UdfIRBuilderTest, inc_int32_udf_test) { CheckUdf<int32_t, int32_t>("inc", 2021, 2020); }
...
TEST_F(UdfIRBuilderTest, sum_udf_test) {
    ...
    codec::ListRef<int32_t> list_ref;
    list_ref.list = reinterpret_cast<int8_t *>(&list);
    CheckUdf<int32_t, codec::ListRef<int32_t>>("sum", 1 + 3 + 5 + 7 + 9, list_ref);
}
...
TEST_F(UdfIRBuilderTest, max_timestamp_udf_test) {
    std::vector<Timestamp> vec = {Timestamp(1590115390000L), Timestamp(1590115410000L), Timestamp(1590115420000L),
                                  Timestamp(1590115430000L), Timestamp(1590115400000L)};
    codec::ArrayListV<Timestamp> list(&vec);
    codec::ListRef<Timestamp> list_ref;
    list_ref.list = reinterpret_cast<int8_t *>(&list);

    Timestamp max_time;
    CheckUdf<Timestamp, codec::ListRef<Timestamp>>("max", Timestamp(1590115430000L), list_ref);
}
TEST_F(UdfIRBuilderTest, min_timestamp_udf_test) {
    ...
    Timestamp max_time;
    CheckUdf<Timestamp, codec::ListRef<Timestamp>>("min", Timestamp(1590115390000L), list_ref);
}
...
TEST_F(UdfIRBuilderTest, atan_udf_test_0) { CheckUdf<double, int16_t>("atan", 0, 0); }
TEST_F(UdfIRBuilderTest, atan_udf_test_1) { CheckUdf<double, int16_t>("atan", 1.1071487177940904, 2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_2) { CheckUdf<double, int32_t>("atan", -1.1071487177940904, -2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_3) { CheckUdf<double, int32_t>("atan", 1.1071487177940904, 2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_4) { CheckUdf<double, int64_t>("atan", 0, 0); }
TEST_F(UdfIRBuilderTest, atan_udf_test_5) { CheckUdf<double, int64_t>("atan", -1.1071487177940904, -2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_6) { CheckUdf<float, float>("atan", atan(-45.01f), -45.01f); }
TEST_F(UdfIRBuilderTest, atan_udf_test_7) { CheckUdf<double, double>("atan", 0.1462226769376524, 0.1472738); }
TEST_F(UdfIRBuilderTest, atan_udf_test_8) { CheckUdf<double, int16_t, int32_t>("atan", 2.3561944901923448, 2, -2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_9) { CheckUdf<double, int64_t, int32_t>("atan", 2.3561944901923448, 2, -2); }
TEST_F(UdfIRBuilderTest, atan_udf_test_10) { CheckUdf<double, int64_t, float>("atan", 2.3561944901923448, 2, -2); }

TEST_F(UdfIRBuilderTest, atan2_udf_test_15) { CheckUdf<double, double, int32_t>("atan2", 2.3561944901923448, 2, -2); }
...
TEST_F(UdfIRBuilderTest, substring_pos_len_udf_test) {
    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef("12345"), StringRef("1234567890"), 1, 5);

    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef("23456"), StringRef("1234567890"), 2, 5);

    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef("23456"), StringRef("1234567890"), -9, 5);

    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef("90"), StringRef("1234567890"), -2, 5);

    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef(""), StringRef("1234567890"), 2, 0);

    CheckUdf<StringRef, StringRef, int32_t, int32_t>("substring", StringRef(""), StringRef("1234567890"), 2, -1);
}

TEST_F(UdfIRBuilderTest, substring_pos_udf_test) {
    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef("1234567890"), StringRef("1234567890"), 1);

    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef("234567890"), StringRef("1234567890"), 2);

    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef("234567890"), StringRef("1234567890"), -9);

    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef("90"), StringRef("1234567890"), -2);

    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef(""), StringRef("1234567890"), 12);
    CheckUdf<StringRef, StringRef, int32_t>("substring", StringRef(""), StringRef("1234567890"), -12);
}
...
TEST_F(UdfIRBuilderTest, get_json_object) {
    ...
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"("c1")"), StringRef(R"({"a": {"c": "c1"}})"), StringRef("$.a.c"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["b2"])"), StringRef(R"([{"b": null}, {"b": "b2"}])"), StringRef("$.[*].b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["b1","b2"])"), StringRef(R"([{"b": "b1"}, {"b": "b2"}])"), StringRef("$.[*].b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["c1","c2"])"), StringRef(R"([{"b": {"c": "c1"}}, {"b": {"c": "c2"}}])"),
        StringRef("$.[*].b.c"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"([{"b":"b1"},{"b":"b2"}])"), StringRef(R"({"ab": [{"b": "b1"}, {"b": "b2"}]})"),
        StringRef("$.ab[*]"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"([{"b":"b1"},{"b":"b2"}])"), StringRef(R"({"ab": [{"b": "b1"}, {"b": "b2"}]})"),
        StringRef("$.ab.[*]"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["b1","b2"])"), StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"),
        StringRef("$.a.[*].b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, nullptr, StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"), StringRef("$.a.[a]"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["b1","b2"])"), StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"),
        StringRef("$.a.[0,1].b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"(["b1"])"), StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"), StringRef("$.a.[0].b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, StringRef(R"({"a":[{"b":"b1"},{"b":"b2"}]})"), StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"),
        StringRef("$"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, nullptr, StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"), StringRef("$.b"));
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(
        udf_name, nullptr, StringRef(R"({"a": [{"b": "b1"}, {"b": "b2"}]})"), nullptr);
    CheckUdf<Nullable<StringRef>, Nullable<StringRef>, Nullable<StringRef>>(udf_name, nullptr, nullptr,
                                                                            StringRef("$.b"));
}

TEST_F(UdfIRBuilderTest, concat_str_udf_test) {
    //    concat("12345") == "12345"
    CheckUdf<StringRef, StringRef>("concat", StringRef("12345"), StringRef("12345"));

    // concat("12345", "67890") == "1234567890"
    CheckUdf<StringRef, StringRef, StringRef>("concat", StringRef("1234567890"), StringRef("12345"),
                                              StringRef("67890"));

    // concat("123", "4567890", "abcde") == "1234567890abcde"
    CheckUdf<StringRef, StringRef, StringRef, StringRef>("concat", StringRef("1234567890abcde"), StringRef("123"),
                                                         StringRef("4567890"), StringRef("abcde"));

    // concat("1", "23", "456", "7890", "abc", "de") == "1234567890abcde"
    CheckUdf<StringRef, StringRef, StringRef, StringRef>("concat", StringRef("1234567890abcde"), StringRef("1"),
                                                         StringRef("23"), StringRef("456"), StringRef("7890"),
...
TEST_F(UdfIRBuilderTest, concat_anytype_udf_test) {
    CheckUdf<StringRef, StringRef, int32_t>("concat", StringRef("1234567890"), StringRef("12345"), 67890);

    CheckUdf<StringRef, float, int32_t>("concat", StringRef("1234.567890"), 1234.5f, 67890);

    CheckUdf<StringRef, StringRef, int16_t, int32_t, int64_t, float, double, Timestamp, Date>(
        "concat", StringRef("12345.67.82020-05-22 10:43:402020-06-23"), StringRef("1"), static_cast<int16_t>(2), 3, 4L,
        5.6f, 7.8, Timestamp(1590115420000L), Date(2020, 06, 23));
}

TEST_F(UdfIRBuilderTest, concat_ws_anytype_udf_test) {
    // concat on string "--"
    CheckUdf<StringRef, StringRef, StringRef, int32_t>("concat_ws", StringRef("12345--67890"), StringRef("--"),
                                                       StringRef("12345"), 67890);

    // concat on int32
    CheckUdf<StringRef, int32_t, float, int32_t>("concat_ws", StringRef("1234.5067890"), 0, 1234.5f, 67890);

    // concat on string "#"
    CheckUdf<StringRef, StringRef, StringRef, int16_t, int32_t, int64_t, float, double, Timestamp, Date>(
        "concat_ws",

        StringRef("1#2#3#4#5.6#7.8#2020-05-22 10:43:40#2020-06-23"), StringRef("#"), StringRef("1"),
        static_cast<int16_t>(2), 3, 4L, 5.6f, 7.8, Timestamp(1590115420000L), Date(2020, 06, 23));
}
...
TEST_F(UdfIRBuilderTest, to_string_test) {
    ...
    CheckUdf<StringRef, int16_t>("string", StringRef("128"), static_cast<int16_t>(128));
    CheckUdf<StringRef, float>("string", StringRef("1.234"), 1.234f);
    CheckUdf<StringRef, double>("string", StringRef("1.234"), 1.234);

    CheckUdf<StringRef, int64_t>("string", StringRef("1234567890"), 1234567890L);

    CheckUdf<StringRef, int64_t>("string", StringRef("1234567890"), 1234567890L);
    CheckUdf<StringRef, Timestamp>("string", StringRef("2020-05-22 10:43:40"), Timestamp(1590115420000L));

    CheckUdf<StringRef, Date>("string", StringRef("2020-05-22"), Date(2020, 5, 22));
}

TEST_F(UdfIRBuilderTest, timestamp_format_test) {
    CheckUdf<StringRef, Timestamp, StringRef>("date_format", StringRef("2020-05-22 10:43:40"),
                                              Timestamp(1590115420000L), StringRef("%Y-%m-%d %H:%M:%S"));

    CheckUdf<StringRef, Timestamp, StringRef>("date_format", StringRef("2020-05-22"), Timestamp(1590115420000L),
                                              StringRef("%Y-%m-%d"));

    CheckUdf<StringRef, Timestamp, StringRef>("date_format", StringRef("10:43:40"), Timestamp(1590115420000L),
                                              StringRef("%H:%M:%S"));
}

TEST_F(UdfIRBuilderTest, date_format_test) {
    CheckUdf<StringRef, Date, StringRef>("date_format", StringRef("2020-05-22 00:00:00"), Date(2020, 05, 22),
                                         StringRef("%Y-%m-%d %H:%M:%S"));

    CheckUdf<StringRef, Date, StringRef>("date_format", StringRef("2020-05-22"), Date(2020, 05, 22),
                                         StringRef("%Y-%m-%d"));

    CheckUdf<StringRef, Date, StringRef>("date_format", StringRef("00:00:00"), Date(2020, 05, 22),
                                         StringRef("%H:%M:%S"));
}

TEST_F(UdfIRBuilderTest, strcmp_udf_test) {
    CheckUdf<int32_t, StringRef, StringRef>("strcmp", 0, StringRef("12345"), StringRef("12345"));
    CheckUdf<int32_t, StringRef, StringRef>("strcmp", 0, StringRef(""), StringRef(""));
    CheckUdf<int32_t, StringRef, StringRef>("strcmp", -1, StringRef("12345"), StringRef("123456"));
    CheckUdf<int32_t, StringRef, StringRef>("strcmp", -1, StringRef(""), StringRef("123456"));

    CheckUdf<int32_t, StringRef, StringRef>("strcmp", 1, StringRef("12345"), StringRef("1234"));
    CheckUdf<int32_t, StringRef, StringRef>("strcmp", 1, StringRef("12345"), StringRef(""));

    CheckUdf<Nullable<int32_t>, Nullable<StringRef>, Nullable<StringRef>>("strcmp", nullptr, nullptr, nullptr);
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>, Nullable<StringRef>>("strcmp", nullptr, StringRef("12345"),
                                                                          nullptr);
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>, Nullable<StringRef>>("strcmp", nullptr, nullptr,
                                                                          StringRef("12345"));
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>, Nullable<StringRef>>("strcmp", nullptr, nullptr, StringRef(""));
}
...
TEST_F(UdfIRBuilderTest, null_process_test) {
    ...
    CheckUdf<double, Nullable<double>, Nullable<double>>("if_null", 1.0, 1.0, nullptr);
    CheckUdf<double, Nullable<double>, Nullable<double>>("if_null", 1.0, 1.0, 2.0);
    CheckUdf<Nullable<double>, Nullable<double>, Nullable<double>>("if_null", nullptr, nullptr, nullptr);
    CheckUdf<double, Nullable<double>, Nullable<double>>("if_null", 2.0, nullptr, 2.0);
...
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_0) {
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", Timestamp(1589904000000L), Date(2020, 05, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_0) {
    //    Invalid year
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, Date(1899, 05, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_1) {
    //    Invalid month
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, Date(2029, 13, 20));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_2) {
    //    Invalid day
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, Date(2029, 05, 32));
}
TEST_F(UdfIRBuilderTest, date_to_timestamp_test_null_3) {
    CheckUdf<Nullable<Timestamp>, Nullable<Date>>("timestamp", nullptr, nullptr);
}

TEST_F(UdfIRBuilderTest, string_to_timestamp_test_0) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", Timestamp(1589907723000),
                                                       StringRef("2020-05-20 01:02:03"));
}
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_1) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", Timestamp(1589904000000L), StringRef("2020-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_2) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", nullptr, StringRef("1899-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_timestamp_test_3) {
    CheckUdf<Nullable<Timestamp>, Nullable<StringRef>>("timestamp", Timestamp(1589904000000L), StringRef("20200520"));
}

TEST_F(UdfIRBuilderTest, timestamp_to_date_test_0) {
    CheckUdf<Nullable<Date>, Nullable<Timestamp>>("date", Date(2020, 05, 20), Timestamp(1589958000000L));
}
...
TEST_F(UdfIRBuilderTest, string_to_date_test_0) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", Date(2020, 05, 20), StringRef("2020-05-20 01:02:03"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_1) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", Date(2020, 05, 20), StringRef("2020-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_2) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", nullptr, StringRef("1899-05-20"));
}
TEST_F(UdfIRBuilderTest, string_to_date_test_3) {
    CheckUdf<Nullable<Date>, Nullable<StringRef>>("date", Date(2020, 05, 20), StringRef("20200520"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_0) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", 1, StringRef("1"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_1) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", -1, StringRef("-1"));
}
TEST_F(UdfIRBuilderTest, string_to_smallint_2) {
    CheckUdf<Nullable<int16_t>, Nullable<StringRef>>("int16", nullptr, StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_int_0) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", 1, StringRef("1"));
}
TEST_F(UdfIRBuilderTest, string_to_int_1) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", -1, StringRef("-1"));
}
TEST_F(UdfIRBuilderTest, string_to_int_2) {
    CheckUdf<Nullable<int32_t>, Nullable<StringRef>>("int32", nullptr, StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_0) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", 1589904000000L, StringRef("1589904000000"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_1) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", -1589904000000L, StringRef("-1589904000000"));
}
TEST_F(UdfIRBuilderTest, string_to_bigint_2) {
    CheckUdf<Nullable<int64_t>, Nullable<StringRef>>("int64", nullptr, StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_double_0) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", 1.0, StringRef("1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_double_1) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", -1.0, StringRef("-1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_double_2) {
    CheckUdf<Nullable<double>, Nullable<StringRef>>("double", nullptr, StringRef("abc"));
}
TEST_F(UdfIRBuilderTest, string_to_float_0) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", 1.0f, StringRef("1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_float_1) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", -1.0f, StringRef("-1.0"));
}
TEST_F(UdfIRBuilderTest, string_to_float_2) {
    CheckUdf<Nullable<float>, Nullable<StringRef>>("float", nullptr, StringRef("abc"));
}
