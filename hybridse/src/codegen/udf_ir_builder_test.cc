...
TEST_F(UdfIRBuilderTest, UnhexTest) {
    ...
    CheckUdf<StringRef, StringRef>("unhex", "Spark SQLSpark", StringRef("537061726B2053514C537061726B"));
    ...
    CheckUdf<StringRef, StringRef>("unhex", "7&�5", StringRef("537061726B2053514"));
