...
template <typename>
struct is_json_pointer : std::false_type {};
...
struct conjunction<B, Bn...> : std::conditional<bool(B::value), conjunction<Bn...>, B>::type {};
...
struct is_constructible_string_type {
    static constexpr auto value = is_constructible<ConstructibleStringType, typename BasicJsonType::string_t>::value;
};
