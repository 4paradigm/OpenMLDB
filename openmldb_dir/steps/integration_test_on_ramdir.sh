...
ulimit -c unlimited
mkdir -p /rambuild/fedb/build/bin
cp build/bin/fedb /rambuild/fedb/build/bin
cp CMakeLists.txt /rambuild/fedb/
cp -rf test-common /rambuild/fedb/
cp -rf release /rambuild/fedb/
cd /rambuild/fedb/
