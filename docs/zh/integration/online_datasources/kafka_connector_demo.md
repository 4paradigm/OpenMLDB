...
- 你需要下载connector包以及依赖，请点击[kafka-connect-jdbc.tgz](https://openmldb.com/download/use_case/kafka_connector/kafka-connect-jdbc.tgz)。
- 你需要下载本文中所需要的配置与脚本等文件，请点击[kafka_demo_files.tgz](https://openmldb.com/download/use_case/kafka_connector/kafka_demo_files.tgz)下载。
