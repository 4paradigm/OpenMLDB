...
本文我们将以[Kaggle上的出租车行车时间预测问题为例](https://www.kaggle.com/c/nyc-taxi-trip-duration/overview)，示范如何使用[OpenMLDB](https://github.com/4paradigm/OpenMLDB)和其他开源工具来打造一个完整的机器学习应用。本案例基于 OpenMLDB 集群版进行教程演示。
