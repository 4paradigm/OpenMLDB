...
| **[gcformat_index](/openmldb_sql/Files/udfs_8h.md#function-gcformat-index)**()| <br>Set the index/lineno of gcformat output. Example: |
...
Set the index/lineno of gcformat output. Example: 
...
**Parameters**: 
  ...
  * **substr** 
  * **str** 
  * **pos** define the beginning search position of the str.
