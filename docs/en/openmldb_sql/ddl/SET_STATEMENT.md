...
| @@session.spark_config｜@@spark_config | Set the Spark configuration for offline jobs, configure like 'spark.executor.memory=2g;spark.executor.cores=2'. Notice that the priority of this Spark configuration is higher than TaskManager Spark configuration but lower than CLI Spark configuration file.                                                                                                                    | String                         | "" |
