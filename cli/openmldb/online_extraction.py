...
def online_extraction_args(args):
    online_extraction(args.sql_file, args.json_file)

def online_extraction(sql_file, json_file):
    print("Run online extraction")
    ...
    rs = connection.execute(sql_text, data)
