...
PACKAGE_NAME=hybridse-0.2.1-beta1-linux-x86_64
curl -LO https://github.com/4paradigm/HybridSE/releases/download/v0.2.1-beta1/hybridse-0.2.1-beta1-linux-x86_64.tar.gz
