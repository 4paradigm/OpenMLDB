...
if [ ! -d "$THIRDSRC_PATH/zookeeper-3.4.14" ]; then
    ...
    curl -SLo thirdsrc.tar.gz https://github.91chifun.workers.dev/https://github.com/jingchen2222/hybridsql-asserts/releases/download/v0.4.0/thirdsrc-2021-08-03.tar.gz
...
if [[ ${HYBRIDSE_SOURCE} = "local" ]]; then
    ...
    if [[ "$OSTYPE" = "darwin"* ]]; then
        curl -SLo hybridse.tar.gz https://github.91chifun.workers.dev/https://github.com/jingchen2222/OpenMLDB/releases/download/hybridse-v0.2.4-20211018/hybridse-0.2.4-20211018-darwin-x86_64.tar.gz
    elif [[ "$OSTYPE" = "linux-gnu"* ]]; then
        if [[ $ARCH = 'x86_64' ]]; then
            curl -SLo hybridse.tar.gz https://github.91chifun.workers.dev/https://github.com/jingchen2222/OpenMLDB/releases/download/hybridse-v0.2.4-20211018/hybridse-0.2.4-20211018-linux-x86_64.tar.gz
