#!/bin/bash
curl ftp://172.27.12.154/pub/team_hpc/titanse/pz-titanse-v0.1.0-release.tar.gz -o pz.tar.gz
tar zxf pz.tar.gz -C ./thirdparty
curl ftp://172.27.12.154/pub/team_hpc/titanse/rocksdb-titanse-v0.0.1-release.tar.gz -o rocksdb.tar.gz
