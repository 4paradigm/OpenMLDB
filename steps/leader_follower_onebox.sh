...
test -d $ROOT/binlog3 && rm -rf $ROOT/binlog3
...
./build/bin/rtidb --binlog_root_path=$ROOT/binlog3 --binlog_single_file_max_size=8 --log_level=debug --gc_safe_offset=0 --gc_interval=1 --endpoint=0.0.0.0:19529 --role=tablet >log2 2>&1 &
sleep 1

./build/bin/rtidb --cmd="create t1 2 1 0 true" --role=client --endpoint=127.0.0.1:19527 --interactive=false 
