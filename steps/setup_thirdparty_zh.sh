...
THIRDPARTY_HOME=https://github.91chifun.workers.dev/https://github.com//jingchen2222/hybridsql-asserts
ZETASQL_HOME=https://github.91chifun.workers.dev/https://github.com//aceforeverd/zetasql
