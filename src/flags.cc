...
DEFINE_string(recycle_bin_ssd_root_path, "/tmp/ssd/recycle/", "specify the root path of recycle bin in ssd");
DEFINE_string(recycle_bin_hdd_root_path, "/tmp/hdd/recycle/", "specify the root path of recycle bin in hdd");
