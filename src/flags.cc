...
DEFINE_int32(name_server_task_failed_time, 1000, "config the time of failed task");
DEFINE_int32(name_server_task_exe_timeout, 1000*60*60*24, "config the timeout of execute task");
