...
TEST_F(LogReplicatorTest,  Init) {
    ...
    std::shared_ptr<MemTable> table = std::make_shared<MemTable>("test", 1, 1, 8, mapping, 0, ::rtidb::common::TTLType::kAbsoluteTime);
    table->Init();
...
TEST_F(LogReplicatorTest,   LeaderAndFollowerMulti) {
    ...
    std::shared_ptr<MemTable> t7 = std::make_shared<MemTable>("test", 1, 1, 8, mapping, 0, ::rtidb::common::TTLType::kAbsoluteTime);
    t7->Init();
    {
    ...
    std::shared_ptr<MemTable> t8 = std::make_shared<MemTable>("test", 1, 1, 8, mapping, 0, ::rtidb::common::TTLType::kAbsoluteTime);
    t8->Init();
    {
