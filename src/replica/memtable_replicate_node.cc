...
MemTableReplicateNode::MemTableReplicateNode(const std::string& endpoint, LogParts* logs, const std::string& log_path,
                             uint32_t tid, uint32_t pid, std::atomic<uint64_t>* term,
...
int MemTableReplicateNode::Init() {
...
void MemTableReplicateNode::MatchLogOffset() {
...
void MemTableReplicateNode::SyncData() {
...
int MemTableReplicateNode::MatchLogOffsetFromNode() {
...
int MemTableReplicateNode::SyncData(uint64_t log_offset) {
