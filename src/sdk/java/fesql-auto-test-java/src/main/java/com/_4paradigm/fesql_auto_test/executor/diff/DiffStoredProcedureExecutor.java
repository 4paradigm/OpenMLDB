...
import com._4paradigm.fesql_auto_test.executor.RequestQuerySQLExecutor;
...
@Slf4j
public class DiffStoredProcedureExecutor extends DiffVersionRequestExecutor {

    private List<String> spNames;

    public DiffStoredProcedureExecutor(SQLCase fesqlCase, SqlExecutor executor, Map<String,SqlExecutor> executorMap, Map<String,FEDBInfo> fedbInfoMap, boolean isBatchRequest, boolean isAsyn) {
        super(fesqlCase, executor, executorMap, fedbInfoMap, isBatchRequest, isAsyn);
