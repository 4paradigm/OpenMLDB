...
struct TabletInfo {
    ...
    bool Health() {
        return state_ == ::openmldb::api::TabletState::kTabletHealthy;
    }
};
...
class ClusterInfo {
 public:
    ...
    bool DropTableRemote(const ::openmldb::api::TaskInfo& task_info,
...
class NameServerImpl : public NameServer {
 ...
 public:
    ...
    void OfflineEndpointDBInternal(
        ...
        const std::map<std::string,
                       std::shared_ptr<::openmldb::nameserver::TableInfo>>&
            table_info);
    ...
    int SyncExistTable(
        ...
        const ::openmldb::nameserver::TableInfo& table_info_local, uint32_t pid,
    ...
    bool DropTableRemote(
        const ::openmldb::api::TaskInfo& task_info, const std::string& name,
        const std::string& db,
        const std::shared_ptr<::openmldb::nameserver::ClusterInfo> cluster_info);

    bool RegisterName();

    bool CreateProcedureOnTablet(const ::openmldb::api::CreateProcedureRequest& sp_request, std::string& err_msg); // NOLINT
 ...
 private:
    ...
    void UpdatePartitionStatus(
        ...
        bool is_alive, std::shared_ptr<::openmldb::api::TaskInfo> task_info);
    ...
    std::shared_ptr<Task> CreateDumpIndexDataTask(
        uint64_t op_index, ::openmldb::api::OPType op_type, uint32_t tid,
    ...
    std::shared_ptr<Task> CreateExtractIndexDataTask(
        ...
        uint32_t partition_num, const ::openmldb::common::ColumnKey& column_key,
        uint32_t idx);
    ...
    int AddOPTask(const ::openmldb::api::TaskInfo& task_info,
    ...
    std::shared_ptr<::openmldb::api::TaskInfo> FindTask(
    ...
    std::shared_ptr<openmldb::nameserver::ClusterInfo> GetHealthCluster(
        const std::string& alias);
    ...
    void RecoverEndpointTable(
        ...
        std::shared_ptr<::openmldb::api::TaskInfo> task_info);
    int GetLeader(std::shared_ptr<::openmldb::nameserver::TableInfo> table_info,
    ...
    int CreateAddIndexOP(const std::string& name, const std::string& db,
                         uint32_t pid, const std::vector<openmldb::common::ColumnDesc>& new_cols,
                         const ::openmldb::common::ColumnKey& column_key, uint32_t idx);
    ...
    void UpdateTableStatusFun(
        const std::map<std::string,
                       std::shared_ptr<::openmldb::nameserver::TableInfo>>&
            table_info_map,
        const std::unordered_map<std::string, ::openmldb::api::TableStatus>&
            pos_response);
    ...
    bool UpdateZkTableNode(
        const std::shared_ptr<::openmldb::nameserver::TableInfo>&
            table_info);  // NOLINT
    ...
    bool AddFieldToTablet(const std::vector<openmldb::common::ColumnDesc>& cols,
                          std::shared_ptr<TableInfo> table_info,
