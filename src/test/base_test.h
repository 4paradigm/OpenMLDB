...
class SQLCaseTest : public ::testing::TestWithParam<fesql::sqlcase::SQLCase> {
 public:
    ...
    static std::vector<fesql::sqlcase::SQLCase> InitCases(const std::string &yaml_path);
    ...
    static void CheckSchema(const fesql::vm::Schema &schema, const fesql::vm::Schema &exp_schema);
    static void CheckSchema(const fesql::vm::Schema &schema, const fesql::sdk::Schema &exp_schema);
    static void PrintRows(const fesql::vm::Schema &schema, const std::vector<fesql::codec::Row> &rows);
    static const std::vector<fesql::codec::Row> SortRows(const fesql::vm::Schema &schema,
    ...
    static void CheckRows(const fesql::vm::Schema &schema, const std::string &order_col,
                          const std::vector<fesql::codec::Row> &rows, std::shared_ptr<fesql::sdk::ResultSet> rs);
    static void CheckRows(const fesql::vm::Schema &schema, const std::vector<fesql::codec::Row> &rows,
    ...
    static void PrintResultSetYamlFormat(std::shared_ptr<fesql::sdk::ResultSet> rs);
    static void PrintResultSetYamlFormat(std::vector<std::shared_ptr<fesql::sdk::ResultSet>> results);
    static void PrintResultSet(std::vector<std::shared_ptr<fesql::sdk::ResultSet>> results);
