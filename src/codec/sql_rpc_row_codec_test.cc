...
void InitSchema(fesql::codec::Schema* schema) {
...
TEST_F(SqlRpcRowCodecTest, TestSingleSlice) {
    ...
    size_t buf_size;
    fesql::codec::RowBuilder builder(schema);
    ...
    fesql::codec::Row row(fesql::codec::RefCountedSlice::CreateManaged(buf, buf_size));
...
TEST_F(SqlRpcRowCodecTest, TestMultiSlice) {
    ...
    builder.AppendFloat(3.14);
    builder.AppendString("hello", 5);
    fesql::codec::Row row(fesql::codec::RefCountedSlice::CreateManaged(buf1, buf_size));
    row.Append(fesql::codec::RefCountedSlice());
    ...
    row.Append(fesql::codec::RefCountedSlice::CreateManaged(buf2, buf_size));
    row.Append(fesql::codec::RefCountedSlice());
