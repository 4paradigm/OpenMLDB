...
TEST_P(TableTest, AbsAndLatGC2) {
    ...
    EXPECT_EQ(200, (int64_t)table->GetRecordIdxCnt());
    EXPECT_EQ(200, (int64_t)table->GetRecordPkCnt());
...
TEST_P(TableTest, TsIdxCntPut) {
    ...
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index0", "test", "ts1", ::openmldb::type::kAbsoluteTime, 100, 0);
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index1", "testnew", "ts2", ::openmldb::type::kAbsoluteTime, 70, 0);
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index2", "testnew", "ts3", ::openmldb::type::kAbsoluteTime, 60, 0);
...
TEST_P(TableTest, TsIdxCntPut2) {
    ...
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index0", "test", "ts1", ::openmldb::type::kLatestTime, 0, 8);
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index1", "testnew", "ts2", ::openmldb::type::kLatestTime, 0, 6);
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index2", "testnew", "ts3", ::openmldb::type::kLatestTime, 0, 5);
    ...
    table->SchedGc();
    EXPECT_EQ(130, (int64_t)table->GetRecordIdxCnt());

    delete table;
}

TEST_P(TableTest, TsIdxCntPut3) {
    ::openmldb::common::StorageMode storageMode = GetParam();
    ::openmldb::api::TableMeta table_meta;
    table_meta.set_name("table1");
    std::string table_path = "";
...
TEST_P(TableTest, TsIdxCntPut5) {
    ...
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index0", "test", "ts1", ::openmldb::type::kAbsoluteTime, 90, 0);
    SchemaCodec::SetIndex(table_meta.add_column_key(), "index1", "testnew", "ts1", ::openmldb::type::kAbsoluteTime, 50, 0);
    ...
    EXPECT_EQ(91, ts_count);

    delete table;
}

TEST_P(TableTest, TsIdxCntPut6) {
    ::openmldb::common::StorageMode storageMode = GetParam();
    ::openmldb::api::TableMeta table_meta;
    table_meta.set_name("table1");
    std::string table_path = "";
    ...
    EXPECT_EQ(41, ts_count);

    delete table;
}

TEST_P(TableTest, TsIdxCntPut7) {
    ::openmldb::common::StorageMode storageMode = GetParam();
    ::openmldb::api::TableMeta table_meta;
    table_meta.set_name("table1");
    std::string table_path = "";
