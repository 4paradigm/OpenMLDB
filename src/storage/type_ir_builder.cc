        ...
        case 1 : 
            {
                ...
                if (next_str_field_offset <= 0) {
                    ...
                    uint8_t str_offset = (uint8_t)(*(row + offset));
                    uint8_t next_str_offset = (uint8_t)(*(row + next_str_field_offset));
                    const int8_t* ptr = row + str_offset;
        ...
        case 2 :
            {
                ...
                if (next_str_field_offset <= 0) {
                    ...
                    uint16_t str_offset = (uint16_t)(*(row + offset));
                    uint16_t next_str_offset = (uint16_t)(*(row + next_str_field_offset));
                    const int8_t* ptr = row + str_offset;
                    sr->size = (uint32_t)(next_str_offset - str_offset);
                    sr->data = (char*)(ptr);  //NOLINT
                }
        ...
        case 3 :
            {
                ...
                if (next_str_field_offset <= 0) {
                    ...
                    str_offset = (str_offset << 8) + (uint8_t)(*(row + offset + 1));
                    str_offset = (str_offset << 8) + (uint8_t)(*(row + offset + 2));
                    uint32_t next_str_offset = (uint8_t)(*(row + next_str_field_offset));
                    next_str_offset = (next_str_offset << 8) + (uint8_t)(*(row + next_str_field_offset + 1));
                    next_str_offset = (next_str_offset << 8) + (uint8_t)(*(row + next_str_field_offset + 2));
                    const int8_t* ptr = row + str_offset;
                    sr->size = (uint32_t)(next_str_offset - str_offset);
                    sr->data = (char*)(ptr);  // NOLINT
                }
        ...
        case 4 :
            {
                ...
                if (next_str_field_offset <= 0) {
                    ...
                    uint32_t str_offset = (uint32_t)(*(row + offset));
                    uint32_t next_str_offset = (uint32_t)(*(row + next_str_field_offset));
                    const int8_t* ptr = row + str_offset;
                    sr->size = (uint32_t)(next_str_offset - str_offset);
                    sr->data = (char*)(ptr);  //NOLINT
                }
