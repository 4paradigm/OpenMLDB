...
TableIndex::TableIndex() {
    ...
    combine_col_name_map_ = std::make_shared<std::map<std::string, std::shared_ptr<IndexDef>>>();
}
...
void TableIndex::ReSet() {
    ...
    pk_index_ = std::shared_ptr<IndexDef>();
    auto new_map = std::make_shared<std::map<std::string, std::shared_ptr<IndexDef>>>();
...
int TableIndex::AddIndex(std::shared_ptr<IndexDef> index_def) {
    ...
    auto new_map = std::make_shared<std::map<std::string, std::shared_ptr<IndexDef>>>(*old_map);
