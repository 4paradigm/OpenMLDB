...
class BsClient {
 public:
    explicit BsClient(const std::string& endpoint, const std::string& real_endpoint);

    BsClient(const std::string& endpoint, const std::string& real_endpoint, bool use_sleep_policy);
