...
ExternalProject_Add(
  ...
  DEPENDS ${GENERAL_DEPS}
  CONFIGURE_COMMAND ${CMAKE_COMMAND} -H<SOURCE_DIR> -B <BINARY_DIR>
    -DCMAKE_INSTALL_PREFIX=${DEPS_INSTALL_DIR} -DGFLAGS_BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DGFLAGS_BUILD_STATIC_LIBS=ON
    -DGFLAGS_NAMESPACE=google ${CMAKE_OPTS}
