...
public class FESQLLastJoinBenchmark {
    ...
    private final String db = "db" + System.nanoTime();
    private final String ddl = "create table t1 (col1 string, col2 timestamp, " +
            "col3 float," +
            "col4 double," +
            "col5 string," +
            "index(key=col1, ts=col2));";

    private final String ddl1 = "create table t2 (col1 string, col2 timestamp, " +
            "col3 float," +
            "col4 double," +
            "col5 string," +
            "index(key=col1, ts=col2));";
