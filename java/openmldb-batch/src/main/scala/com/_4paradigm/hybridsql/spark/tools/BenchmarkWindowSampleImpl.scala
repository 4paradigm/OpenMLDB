...
package com._4paradigm.hybridsql.spark.tools

import java.io.{File, FileWriter}

import com._4paradigm.hybridsql.spark.SparkFeConfig
import com._4paradigm.hybridsql.spark.nodes.window.WindowSampleSupport
import com._4paradigm.hybridsql.spark.nodes.window.WindowSampleSupport.SampleExecutor
import com._4paradigm.hybridsql.spark.utils.{ArgumentParser, JmhHelper}
...
class BenchmarkWindowSampleImpl {
  ...
  def initExecutor(): Unit = {
    executor = WindowSampleSupport.recover(new SparkFeConfig, samplePath, sampleIdx)
  }
