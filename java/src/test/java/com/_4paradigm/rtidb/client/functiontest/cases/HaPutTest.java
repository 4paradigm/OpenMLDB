...
public class HaPutTest extends TestCaseBase {
    ...
    private String createKvTable() {
        ...
        PartitionMeta pm0_0 = PartitionMeta.newBuilder().setEndpoint(Config.NODES[0]).setIsLeader(true).build();
        PartitionMeta pm0_1 = PartitionMeta.newBuilder().setEndpoint(Config.NODES[1]).setIsLeader(false).build();
    ...
    private String createSchemaTable(Boolean isIndex1, String type1, Boolean isIndex2, String type2) {
        ...
        PartitionMeta pm0_0 = PartitionMeta.newBuilder().setEndpoint(Config.NODES[0]).setIsLeader(true).build();
        PartitionMeta pm0_1 = PartitionMeta.newBuilder().setEndpoint(Config.NODES[1]).setIsLeader(false).build();
        PartitionMeta pm0_2 = PartitionMeta.newBuilder().setEndpoint(Config.NODES[2]).setIsLeader(false).build();
    ...
    public Object[][] putGetScanSchema() {
        return new Object[][]{
                ...
                {true, "string", "1111", false, "float", 10.0f, true},
                {true, "string", "1111", false, "float", 10.01f, true},
                {true, "string", "1111", false, "float", -1e-1f, true},
                {true, "string", "1111", false, "float", 1e-10f, true},
