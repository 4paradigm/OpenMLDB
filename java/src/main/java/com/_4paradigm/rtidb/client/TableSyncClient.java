...
public interface TableSyncClient {
    ...
    // for single node
    boolean put(int tid, int pid, String key, long time, byte[] bytes) throws TimeoutException;

    boolean put(int tid, int pid, String key, long time, String value) throws TimeoutException;
    ...
    KvIterator scan(int tid, int pid, String key, long st, long et) throws TimeoutException;

    KvIterator scan(int tid, int pid, String key, String idxName, long st, long et) throws TimeoutException;
