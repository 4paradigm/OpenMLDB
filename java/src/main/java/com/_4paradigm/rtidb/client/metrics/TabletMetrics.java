...
public class TabletMetrics {
    ...
    private ScheduledExecutorService sched = Executors.newScheduledThreadPool(1, new ThreadFactory() {
    ...
    private void showSingleMetrics(String label, LinkedList data) {
        ...
        logger.info("[Metrics] {} ctime {} tp9999 {}us, tp999 {}us, tp99 {}us, tp90 {}us, tp50 {}us", label,
                System.currentTimeMillis(), (Long) data.get(index9999) / 1000l, (Long) data.get(index999) / 1000l,
