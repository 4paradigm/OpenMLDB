...
public enum ColumnType {
    kString(0), kFloat(1), kInt32(2), kInt64(3), kDouble(4), kNull(5), kUInt32(6), kUInt64(7), kTimestamp(8), kDate(9), kInt16(10), kUInt16(11), kBool(12), kEmptyString(100);
    ...
    public static ColumnType valueFrom(String val) {
        if ("string".equals(val)) {
            ...
            return kBool;
        } else if ("emptyString".equals(val)) {
            return kEmptyString;
        }
        throw new RuntimeException("not supported type with " + val);
    }
