...
public interface SyncToolInterface {
    ...
    DataSync.GeneralResponse CreateSyncTask(DataSync.CreateSyncTaskRequest request);

    @BrpcMeta(serviceName = "openmldb.datasync.SyncTool", methodName = "DeleteSyncTask")
    DataSync.GeneralResponse DeleteSyncTask(DataSync.DeleteSyncTaskRequest request);

    @BrpcMeta(serviceName = "openmldb.datasync.SyncTool", methodName = "TaskStatus")
    DataSync.TaskStatusResponse TaskStatus(DataSync.TaskStatusRequest request);
    // TODO(hw): is pause/resume needed?

    @BrpcMeta(serviceName = "openmldb.datasync.SyncTool", methodName = "SendData")
    DataSync.SendDataResponse SendData(DataSync.SendDataRequest request);
}
