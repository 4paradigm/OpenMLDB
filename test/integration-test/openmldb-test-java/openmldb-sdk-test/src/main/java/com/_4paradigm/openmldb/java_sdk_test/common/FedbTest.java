    ...
    public void beforeTest(@Optional("qa") String env,@Optional("main") String version,@Optional("")String fedbPath) throws Exception {
        ...
        if(env.equalsIgnoreCase("cluster")){
            ...
            FedbGlobalVar.mainInfo = FEDBInfo.builder()
                    ...
                    .zk_cluster("172.24.4.55:10007")
                    .zk_root_path("/openmldb")
                    .nsNum(2).tabletNum(3)
                    .nsEndpoints(Lists.newArrayList("172.24.4.55:10011", "172.24.4.55:10012"))
                    .tabletEndpoints(Lists.newArrayList("172.24.4.55:10008", "172.24.4.55:10009", "172.24.4.55:10010"))
                    .apiServerEndpoints(Lists.newArrayList("172.24.4.55:10013"))
                    .build();
