 ...
 */
@Slf4j
public class ColumnsCheckerByOffline extends BaseChecker {
    public ColumnsCheckerByOffline(ExpectDesc expect, OpenMLDBResult openMLDBResult) {
    ...
    public void check() throws Exception {
        ...
        List<String> expectColumns = expect.getOfflineColumns();
        if (expectColumns == null || expectColumns.size() == 0) {
            return;
        }
        List<String> columnNames = openMLDBResult.getOfflineColumns();
