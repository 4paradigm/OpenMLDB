...
public abstract class AbstractSQLHandler {
    ...
    public abstract OpenMLDBResult onHandle(OpenMLDBInfo openMLDBInfo, String dbName, String sql);

    public OpenMLDBResult doHandle(OpenMLDBInfo openMLDBInfo, String dbName, String sql){
        if(preHandle(sql)){
